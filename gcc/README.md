if you're on windows, you can download the i686-windows zip from [here](https://github.com/lordmilko/i686-elf-tools/releases/) and unzip in this folder(should be like ./bin, ./lib and that)
